...
- **궁극적으로는..** 특정 기술에 얽매이지 않고, 혼자서도 뭐든 뚝딱 만들어낼 수 있는 **풀스택 역량**을 손에 넣고 싶습니다. <br/>이 막연하지만 소중한 목표가 저를 나아가게 하는 가장 큰 **원동력**입니다.
...
- **UMC 9th** Node.JS Server 파트 - Best  Challenger `2025.09 ~ 2026.02` 🛡️
- **Sure Soft Tech** 시험자동화연구소 소속 VSPICE팀 인턴 - 풀스택 개발 `2026.03 ~ ` 🏢
...
| 2026.01 ~ 02 | [🗓️ 알바로그 ](https://github.com/UMC-AlbaLog/Node.JS) | 알바 스케줄·수입 통합 관리 서비스 | Node.js(Express) / BE | 📱앱 정식 출시 완료 |
