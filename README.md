...
- **UMC 9th** Node.JS Server 파트 `2025.09 ~ ` 🛡️
...
| 2025.08 ~ | [🕊 쉼표](https://github.com/ShymPyo) | 무더위 쉼터 지도 - 앱 | React Native / FE + Design | K-paas 공모전 출품작 |
| 2025.09 ~ | [🤖 Neo& X MFS ](https://github.com/Jinacker/neon_maker) | 2025 메이커페어 서울 부스 소개 페이지 | React / FE + Design | 행사 현장 안내용 |
| 2025.11 ~ | [🧇 돈가스 지도 ](https://github.com/Katsu-Map) | 첫 1인 개발 런칭 프로젝트 | 기획 / 디자인 / RN+Nest 개발 | 📱앱 정식 출시 완료 |
